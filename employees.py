...
def connect_database():
    try:
        ...
        return 
    cursor.execute('CREATE DATABASE IF NOT EXIST invenotry_system')
    cursor.execute('USE inventory_system')
    cursor.execute('CREATE TABLE IF NOT EXIST employee_data (empid INT PRIMARY KEY, name VARCHAR(100), email VARCHAR(100), gender VARCHAR(50), dob VARCHAR(30), contact VARCHAR(30), employment_type VARCHAR(50), work_shift VARCHAR(50), address VARCHAR(100), doj VARCHAR(30), salary VARCHAR(50), usertype VARCHAR(50), password VARCHAR(50))')
